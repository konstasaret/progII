...
public class Answers {
  ...
  public void Answer2() {
    ...
    System.out.println("περίοδο επώασης αλλά αυτές αποτελούν μάλλον εξαιρέσεις του "
        + "γενικού κανόνα.");
  }

  public void Answer3() {
    System.out.println("Πρόσφατη μελέτη από την Κίνα, που δημοσιεύθηκε στις 28 Φεβρουαρίου"
        + " 2020 από το");
    System.out.println(" New England Journal of Medicine και περιλάμβανε 1099 "
        + "ασθενείς που νοσηλεύθηκαν");
  ...
  public void Answer4() {
    System.out.println("Ναι, μπορούν οι ασυμπτωματικοί φορείς να μεταδίδουν τον ιό. "
        + "Ωστόσο, δεν έχει εξακριβωθεί");
  ...
  public void Answer10() {
    System.out.println("Οι ταξιδιωτικές οδηγίες υφίστανται διαρκώς τροποποιήσεις με βάση "
        + "τα διαρκώς");

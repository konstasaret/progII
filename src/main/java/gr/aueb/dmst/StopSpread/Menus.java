...
public class Menus {
	...
	public void firstMenu() { // beginning of firstMenu
		...
		System.out.println("7. Συχνές Ερωτήσει σχετικά με τον CONVID-19");
	...
	public void menu88() { // beginning of menu88
		...
		System.out.println(
				"Ερώτηση 8 : Μπορώ να αποδέχομαι με ασφάλεια πακέτα από Κίνα " + "ή από άλλα κράτη που ενδημεί ο ιός?");

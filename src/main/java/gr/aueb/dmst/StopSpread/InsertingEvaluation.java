...
public class InsertingEvaluation {
	...
	public void printRabdogramma() {//beggining of Rabdogramma
		System.out.printf("Πολύ κακή εφαρμογή : ");
		for(int stars = 0; stars < markarray[0]; stars++) {//beggining of loop
			System.out.print("*"); //prints strars
		}//ending of loop
		System.out.println();
		System.out.printf("Kακή εφαρμογή : ");
		for(int stars = 0; stars < markarray[1]; stars++) {//beggining of loop
			System.out.print("*"); //prints strars
		}//ending of loop
		System.out.println();
		System.out.printf("Μέτρια εφαρμογή : ");
		for(int stars = 0; stars < markarray[2]; stars++) {//beggining of loop
			System.out.print("*"); //prints strars
		}//ending of loop
		System.out.println();
		...
		for(int stars = 0; stars < markarray[4]; stars++) {//beggining of loop
			System.out.print("*"); //prints strars
		}//ending of loop
		System.out.println();
